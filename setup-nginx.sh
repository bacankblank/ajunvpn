...
#install ssh ovpn
wget https://raw.githubusercontent.com/bacankblank/ajunvpn/main/ssh-vpn-nginx.sh && chmod +x ssh-vpn-nginx.sh && screen -S ssh-vpn-nginx ./ssh-vpn-nginx.sh
...
#install v2ray
wget https://raw.githubusercontent.com/bacankblank/ajunvpn/main/v2ray-nginx.sh && chmod +x v2ray-nginx.sh && screen -S v2ray-nginx ./v2ray-nginx.sh
#wget https://raw.githubusercontent.com/bacankblank/ajunvpn/main/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install L2TP
wget https://raw.githubusercontent.com/bacankblank/ajunvpn/main/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
